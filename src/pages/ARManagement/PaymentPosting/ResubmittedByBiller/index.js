...
function ViewClaim() {
  ...
  function handleClick() {
    history.push('/ResubmittedclaimView');
  }
...
class ResubmittedbyBiller extends Component {
  constructor(props) {
    super(props);
...
export default withStyles(useStyles)(ResubmittedbyBiller);
