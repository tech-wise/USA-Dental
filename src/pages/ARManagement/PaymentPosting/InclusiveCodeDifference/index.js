...
function ViewClaim() {
  ...
  function handleClick() {
    history.push('/InclusivecodedifferenceView');
  }
...
const data = [
  {
    ...
    current:'0.00',
    total:'110.58',
    status:'Inclusive Code Difference'
   },
  {
    sr: 2,
    uid:'ShUw3780444019',
...
class InclusiveCodeDifference extends Component {
  constructor(props) {
    super(props);
...
export default withStyles(useStyles)(InclusiveCodeDifference);
