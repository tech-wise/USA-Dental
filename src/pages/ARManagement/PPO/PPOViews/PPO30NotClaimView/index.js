...
export default function PPO30NotClaimView() {
        ...
        <div className="card-header">
          <div className="card-header--title">
            <h4 className="font-size-lg mb-0 py-2 font-weight-bold color-pb">
              PPO - 30 CALLED NOT WORKED Claim
            </h4>
          </div>
            ...
            <Table className={classes.table} aria-label="simple table">
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell className="text-secondary">ABC.pdf</TableCell>
                  <TableCell
                    component="th"
                    scope="row"
                    className={classes.heading}>
                  ...
                  <TableCell className="text-secondary">abc.png</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </TableContainer>
