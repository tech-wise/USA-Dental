          ...
          <Grid item xl={3} md={6}>
            <Card className="card-box border-0 shadow-first-sm p-4">
              <div className="d-flex align-items-center">
                ...
                <div className="text-black-50">Incomes</div>
              </div>
          ...
          <Grid item xl={3} md={6}>
            <Card className="card-box border-0 shadow-success-sm p-4">
              <div className="d-flex align-items-center">
                ...
                <div className="text-black-50">Checks</div>
              </div>
              <div className="display-3 text-center line-height-sm text-second text-center d-flex align-items-center pt-3 justify-content-center">
                <FontAwesomeIcon
                  icon={['far', 'dot-circle']}
          ...
          <Grid item xl={3} md={6}>
            <Card className="card-box border-0 shadow-danger-sm p-4">
              <div className="d-flex align-items-center">
                ...
                <div className="text-black-50">Bonuses</div>
              </div>
              <div className="display-3 text-center line-height-sm text-second text-center d-flex align-items-center pt-3 justify-content-center">
                <FontAwesomeIcon
                  icon={['fas', 'arrow-up']}
          ...
          <Grid item xl={3} md={6}>
            <Card className="card-box border-0 shadow-primary-sm p-4">
              <div className="d-flex align-items-center">
                ...
                <div className="text-black-50">Salaries</div>
              </div>
              <div className="display-3 text-center line-height-sm text-second text-center d-flex align-items-center pt-3 justify-content-center">
                <FontAwesomeIcon
                  icon={['fas', 'arrow-down']}
