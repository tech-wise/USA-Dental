...
import SrcSampleImage from './../../../../assets/images/sample.gif';
...
export default function ViewAccountCheck() {
            ...
            <Table className={classes.table} aria-label="simple table">
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>US-A147852654</TableCell>
                  <TableCell
                    component="th"
                    scope="row"
                    className={classes.heading}>
                  ...
                  <TableCell>09/28/2020</TableCell>
                </TableRow>
                {/* --- */}
                <TableRow>
                  <TableCell
                  ...
                  <TableCell>$12000.00</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell colSpan={4} className="text-center">
                    <img src={SrcSampleImage} alt="Bank Check" className="img-fluid"/>
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell colSpan={4} className="text-center">
                  <Button size="small" className="btn-neutral-primary btn-hover">
                  <GetAppIcon />&nbsp; Download Check
                </Button>
                  </TableCell>
                </TableRow>
                {/* ---
