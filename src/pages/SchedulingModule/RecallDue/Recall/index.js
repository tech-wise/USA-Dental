  ...
  },
  {
    ...
    options: {
      ...
      customBodyRender: (value, tableMeta, updateValue) => {
        if(value===1)
        return (
          <div className="badge badge-success badge-pill mx-1">Recall</div>
          );
        else
        return (
...
class RecallnoSchedule extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default RecallnoSchedule;
