...
export default function ViewDailyScheduled() {
        ...
        <CardContent>
          <TableContainer>
            <Table className={classes.table} aria-label="simple table">
              ...
              <TableBody>
                <TableRow>
                  <TableCell colSpan={4}>Awaiting.....</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell
                    component="th"
                ...
                <TableRow>
                  ...
                  <TableCell>Dr. Vajahat Yar Khan</TableCell>
                </TableRow>
                {/* --- */}
                <TableRow>
                  <TableCell
