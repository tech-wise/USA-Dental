...
function AddSchedule() {
  ...
  function handleClick() {
    history.push('/AddDailyScheduled');
  }
...
function ViewSchedule() {
  ...
  function handleClick() {
    history.push('/ViewDailyScheduled');
  }
...
function EditSchedule() {
  let history = useHistory();
  function handleClick() {
    history.push('/EditDailyScheduled');
  }
...
const data = [
  ...
  },
  {
    ...
    service: '12/25/18',
    appointment: '08:00 PM',
    provider:'Dr. Vajahat Yar Khan',
    status:1
  }
];
class DailyScheduled extends Component {
  constructor(props) {
    super(props);
