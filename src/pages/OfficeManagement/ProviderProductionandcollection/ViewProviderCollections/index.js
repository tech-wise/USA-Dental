...
export default function ViewProviderCollections() {
            ...
            <Table className={classes.table} aria-label="simple table">
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>+1045236585</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell
                    component="th"
                ...
                <TableRow>
                  <TableCell colSpan={4} className="text-right">
                    <span className="font-weight-bold color-pb">Total &nbsp; $350.63</span>
                  </TableCell>
                </TableRow>
                {/* ---
                <TableRow>
