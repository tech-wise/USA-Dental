...
function ViewTFLClaim() {
  let history = useHistory();
  function handleClick() {
    history.push('/ViewTFLClaimReport');
  }
...
export default function TFLClaims() {
  const options = {
    filterType: 'dropdown',
      ...
      <Card className="card-box mb-spacing-6-x2">
        <div className="card-header">
          ...
          {/* <div className="card-header--actions">
            <div>
            You can add text and button here!
            </div>
          </div> */}
        </div>
